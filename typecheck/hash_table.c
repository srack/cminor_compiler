...
struct hash_table *hash_table_create(int bucket_count, hash_func_t func, struct hash_table *next)
{
	struct hash_table *h;
...
{
	struct hash_table *hn = hash_table_create(2 * h->bucket_count, h->hash_func, 0);
